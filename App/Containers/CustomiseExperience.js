...
import { BeforeLoginHeader, Button, CustomiseExperienceCard, FloatingView } from '../Components';
                    ...
                    <FloatingView isDark={isDark} content={
                        <>
                            ...
                            <View style={styles.container}>
                                ...
                                <Button hasArrow title={'Next'} onPress={() => navigation.navigate('ConnectAddress')} />
